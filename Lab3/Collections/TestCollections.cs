...
namespace lr3
{
    internal class TestCollections
    {
        ...
        //метод, який показує час пошуку елементу в списках List<Edition> та List<string>, час пошуку елементу по ключу  та
        //час пошуку елементу по значенню в колекціях-словниках Dictionary<Edition, Magazine> та Dictionary<string, Magazine>
